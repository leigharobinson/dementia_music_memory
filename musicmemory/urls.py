...
from musicmemoryapi.views import CaretakerView, UserView, SongView, MoodView
...
from musicmemoryapi.views import SongResponseView
...
router.register(r'songresponses', SongResponseView, 'songresponse')
